 ...
 */
final class Version20230121114251 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE periode (id INT AUTO_INCREMENT NOT NULL, gite_id INT DEFAULT NULL, start_at DATE DEFAULT NULL, end_at DATE DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, INDEX IDX_93C32DF3652CAE9B (gite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE photo (id INT AUTO_INCREMENT NOT NULL, gite_id INT NOT NULL, is_main TINYINT(1) NOT NULL, image_name VARCHAR(255) NOT NULL, image_size INT NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_14B78418652CAE9B (gite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE periode ADD CONSTRAINT FK_93C32DF3652CAE9B FOREIGN KEY (gite_id) REFERENCES gite (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE periode DROP FOREIGN KEY FK_93C32DF3652CAE9B');
